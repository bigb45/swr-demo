...
export async function selectShippingAction(
  ...
  // and survives soft refreshes). Also capture the `payment_methods` list —
  // Magento only returns it here, so the review step would otherwise need
  // another round-trip to render the radios.
