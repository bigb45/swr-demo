...
export default async function QuotationDetailPage({
  ...
  // TODO(erp): add an "Accept quotation" action that posts the quotation
  // lines into the cart and redirects to /cart. Blocked on backend accept
  // endpoint; see PRD follow-up.
