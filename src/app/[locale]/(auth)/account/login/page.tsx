...
// via the `?from=` query parameter. Anything else (external URLs, protocol-relative
// `//evil.com` paths, or empty values) falls back to the home page.
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <Link
            ...
            className="text-[11px] font-semibold text-on-surface-variant hover:text-on-surface text-center"
          >
            {t("forgotLink")}
          </Link>
        </form>
